...
public class ScoreboardRenderer {
    ...
    public ScoreboardRenderer(List<GameComparisonScoreboard> games) {
        this.games = games;
    }
    ...
    private String renderSinglePlayer(GameComparisonScoreboard game, String header,
        ...
        String nameRow = String.format("%15s", presentName + " - " + game.scoreLabel(presentSb));
    ...
    private String renderTwoPlayer(GameComparisonScoreboard game, String header,
        ...
        String nameRow = String.format("%15s  |  %s",
