...
public class StatusMessageBuilder {
    ...
    private static final List<GameRow> GAME_ROWS = List.of(
            ...
            new GameRow(BotText.GAME_LABEL_MAIN,        Scoreboard::getDailyCrosswordResult)
    );
    ...
    public StatusMessageBuilder(List<Scoreboard> scoreboards, List<String> playerNames, String contextMessage) {
