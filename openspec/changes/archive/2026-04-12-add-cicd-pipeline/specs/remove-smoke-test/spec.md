...
Defines requirements for the deletion of `SmokeTest.java`, which has been superseded by `EndToEndTest`, and the removal of any references to it in documentation and build commands.
