...
Defines requirements for the standalone release workflow: building the project and publishing a GitHub Release with the JAR attached, triggered only via `workflow_dispatch`.
